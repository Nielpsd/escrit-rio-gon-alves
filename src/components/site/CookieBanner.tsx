    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-2xl rounded-2xl border border-[var(--border)] bg-white p-5 shadow-[var(--shadow-lg)] sm:bottom-6 sm:left-6 sm:right-auto sm:max-w-md"
        >
