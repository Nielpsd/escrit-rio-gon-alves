-- Expande conteúdo dos artigos do blog com textos completos em HTML

UPDATE public.posts SET content = $content$
<h2>O valor médio dos benefícios do INSS</h2>
...
<p>A Reforma da Previdência de 2019 criou cinco regras de transição para quem já contribuía antes da reforma. São elas: pedágio de 50%, pedágio de 100%, regra de pontos, regra de idade progressiva e a regra de tempo de contribuição com redutores. Cada uma gera um resultado diferente dependendo do histórico individual de cada segurado.</p>
...
<li><strong>Aguardar o momento certo:</strong> em algumas regras, aposentar um ou dois anos mais tarde pode resultar em aumento significativo do coeficiente aplicado à média.</li>
...
$content$
WHERE slug = 'quanto-paga-o-inss-para-a-maioria-dos-brasileiros-entenda';

UPDATE public.posts SET content = $content$
<h2>O que estava em jogo com o projeto de lei</h2>
...
<li><strong>Auxílio por incapacidade temporária:</strong> nos períodos de descompensação ou internação, o auxílio-doença (agora chamado auxílio por incapacidade temporária) pode ser requerido.</li>
...
$content$
WHERE slug = 'lula-veta-projeto-que-equipara-diabetes-tipo-1-a-deficiencia';

UPDATE public.posts SET content = $content$
<h2>O que dizia o projeto de lei antes do veto</h2>
...
<p>Especialistas em direito previdenciário alertam que, embora o projeto vetado fosse o caminho mais direto, existem outras alternativas legais que cada família pode explorar com o apoio de um advogado.</p>

<h2>O que ainda é possível buscar na Justiça</h2>
<ul>
<li><strong>Salário-maternidade:</strong> em caso de natimorto, a segurada tem direito ao salário-maternidade pelo período mínimo de duas semanas, conforme a legislação previdenciária vigente. É um direito frequentemente desconhecido e não pago espontaneamente.</li>
...
$content$
WHERE slug = 'lula-vetou-pensao-para-maes-de-criancas-com-anencefalia-entenda';

UPDATE public.posts SET content = $content$
<h2>O trabalhador rural tem proteção especial na Previdência</h2>
...
<p>É importante destacar que o trabalho ocasional fora da propriedade não descaracteriza a condição de segurado especial, desde que a renda obtida seja destinada ao sustento do grupo familiar e não seja superior ao limite legal.</p>

<h2>Como provar a atividade rural sem carteira</h2>
<p>A ausência de registro em carteira não é um obstáculo intransponível. O INSS aceita uma série de documentos para comprovar a atividade rural, que devem cobrir o período de 15 anos exigido:</p>
<ul>
...
<li><strong>Recibos de pagamento do Funrural</strong> (contribuição previdenciária rural)</li>
<li><strong>Certidão de casamento ou nascimento</strong> mencionando a profissão de lavrador ou agricultor</li>
<li><strong>Testemunhas</strong> que possam confirmar a atividade rural em audiência</li>
</ul>

<h2>O INSS frequentemente nega — mas é possível recorrer</h2>
<p>O INSS tem uma postura bastante restritiva na análise de benefícios rurais. É comum que a autarquia exija documentos contemporâneos para cada ano do período de carência, o que muitas vezes é impossível para o trabalhador rural. Nesses casos, a via judicial costuma ser mais eficaz.</p>
...
<p>Quem tem direito ao benefício mas não requereu ainda pode receber retroativos desde a data em que preencheu os requisitos — ou desde a data do requerimento, o que for mais recente. Por isso, não vale a pena esperar. Consulte um advogado previdenciário para levantar a documentação disponível e avaliar o melhor momento para dar entrada no benefício.</p>
$content$
WHERE slug = 'trabalhador-rural-sem-carteira-tem-direito-a-aposentadoria';

UPDATE public.posts SET content = $content$
<h2>Negativa do INSS: mais comum do que parece</h2>
<p>A negativa do auxílio por incapacidade temporária (antigo auxílio-doença) é um dos motivos mais frequentes de busca por advogados previdenciários em todo o Brasil. Segundo dados do próprio INSS, uma parcela significativa dos pedidos é indeferida na análise inicial — e boa parte dessas negativas é revertida em recursos administrativos ou ações judiciais.</p>
<p>Se o INSS negou seu benefício, é fundamental entender os motivos do indeferimento antes de decidir o próximo passo. A carta de indeferimento traz o código do motivo e, muitas vezes, o prazo para recorrer.</p>

<h2>Principais motivos de negativa e como contestar</h2>
<ul>
<li><strong>Carência não cumprida:</strong> para o auxílio-doença, são necessárias 12 contribuições mensais. Se a negativa foi por falta de carência, verifique se há períodos de contribuição não registrados no CNIS — erros são frequentes.</li>
<li><strong>Qualidade de segurado perdida:</strong> mesmo sem contribuir, o segurado mantém seus direitos por um período de graça (de 12 a 36 meses, dependendo do caso). Se o INSS negou por perda de qualidade, verifique se o período de graça foi corretamente calculado.</li>
...
<li><strong>Incapacidade inferior a 15 dias:</strong> o INSS só concede o benefício se a incapacidade for superior a 15 dias consecutivos. Se sua incapacidade foi considerada inferior a esse prazo, pode ser necessário comprovar que os sintomas se estenderam além disso.</li>
</ul>

<h2>Recurso administrativo: o primeiro passo</h2>
<p>Após a negativa, você tem 30 dias para interpor recurso administrativo junto à Junta de Recursos do INSS. O recurso é gratuito e pode ser feito pela internet, pelo aplicativo Meu INSS ou pessoalmente em uma agência. Nele, você pode apresentar novos documentos médicos e contestar o laudo pericial.</p>
...
<li>Receituários e comprovantes de tratamento em andamento</li>
...
<p>Se o recurso administrativo for negado ou se o INSS não responder dentro do prazo (45 dias), é possível ingressar com ação judicial na Justiça Federal ou nos Juizados Especiais Federais. Em casos de urgência comprovada — como risco de vida ou estado grave — é possível requerer tutela antecipada, que obriga o INSS a pagar o benefício provisoriamente enquanto o processo corre.</p>
<p>A via judicial tem prazos mais favoráveis ao segurado e permite uma análise mais completa da situação, sem as limitações da perícia administrativa do INSS. Muitos casos que foram negados administrativamente são revertidos na Justiça.</p>

<h2>Não fique sem renda durante o processo</h2>
<p>Enquanto o benefício está suspenso ou sendo contestado, o trabalhador não pode ser demitido por justa causa com base na doença. Se você ainda está empregado, comunique ao empregador e mantenha atestados. Se já estava afastado e o benefício acabou, o empregador é obrigado a reintegrá-lo ou pagar indenização compensatória — a situação exige análise cuidadosa de um especialista.</p>
$content$
WHERE slug = 'o-inss-negou-seu-auxilio-doenca-veja-o-que-fazer-agora';
...
<li>Contribuíram por longos períodos como autônomos ou empresários com bases de contribuição altas antes de 1994</li>
</ul>
<p>Por outro lado, para quem ganhava mais após 1994 ou tinha pouco tempo de contribuição antes dessa data, a revisão pode resultar em benefício menor — e nesse caso, não deve ser solicitada.</p>
...
<p>Com o julgamento do STF em 2022, muitos processos que estavam suspensos voltaram a tramitar, e novos pedidos administrativos e judiciais passaram a ser aceitos. Se você se aposentou entre 2013 e 2023, o prazo ainda não expirou.</p>

<h2>Como solicitar a revisão</h2>
<p>O primeiro passo é fazer uma simulação comparando o benefício atual com o que seria calculado com a inclusão das contribuições pré-1994. Essa simulação requer acesso ao extrato completo do CNIS e, muitas vezes, a documentos antigos como carteiras de trabalho, fichas de salário e contratos.</p>
<p>Se a revisão for vantajosa, o pedido pode ser feito:</p>
<ul>
<li><strong>Administrativamente:</strong> pelo Meu INSS, com solicitação de revisão e apresentação de documentos</li>
<li><strong>Judicialmente:</strong> por ação judicial, caso o INSS indefira o pedido administrativo — o que é comum nesse tipo de revisão</li>
</ul>
...
$content$
WHERE slug = 'revisao-da-vida-toda-ainda-da-tempo-de-pedir';
...
<li>Rendimentos de trabalho de pessoa com deficiência que está em processo de inclusão no mercado de trabalho (dentro dos limites legais)</li>
</ul>
...
<ol>
<li>Inscrição no <strong>CadÚnico</strong> (Cadastro Único para Programas Sociais do Governo Federal), atualizada há menos de dois anos, no CRAS do seu município</li>
...
<li>Apresentação de documentos: RG, CPF, comprovante de residência e documentos de renda de todos os membros da família</li>
</ol>

<h2>O INSS negou o BPC — e agora?</h2>
<p>A negativa do BPC é muito comum, especialmente quando o INSS entende que a renda familiar está acima do limite ou que a deficiência não atinge o grau de impedimento exigido. Nesses casos, é possível:</p>
<ul>
<li>Interpor <strong>recurso administrativo</strong> no prazo de 30 dias</li>
<li>Ingressar com <strong>ação judicial</strong> nos Juizados Especiais Federais, com possibilidade de tutela antecipada para recebimento imediato do benefício em casos urgentes</li>
</ul>
<p>A jurisprudência dos tribunais federais tem sido cada vez mais favorável ao reconhecimento do BPC em casos de negativa injustificada, especialmente quando a vulnerabilidade social é evidente mesmo que a renda per capita esteja marginalmente acima do limite legal.</p>
$content$
WHERE slug = 'bpcloas-quem-tem-direito-ao-beneficio-de-r-1412-do-governo';

UPDATE public.posts SET content = $content$
<h2>O salário-maternidade existe para proteger a mãe, não o emprego</h2>
...
<p>O que garante esse direito é o chamado "período de graça": um intervalo de tempo após a última contribuição ao INSS durante o qual a segurada mantém a qualidade de segurada e, portanto, seus direitos previdenciários — incluindo o salário-maternidade.</p>
...
<ul>
<li><strong>12 meses</strong> para a segurada que perdeu o emprego com carteira assinada (após o término do benefício de desemprego, se houver)</li>
<li><strong>12 meses</strong> para a segurada que parou de contribuir voluntariamente como autônoma ou contribuinte individual</li>
...
<p>Se o parto, adoção ou guarda ocorrer dentro desse período, a segurada tem direito ao salário-maternidade normalmente.</p>

<h2>Outros grupos que têm direito mesmo sem carteira</h2>
<p>Além das desempregadas em período de graça, outros grupos têm direito ao salário-maternidade independentemente de vínculo empregatício formal:</p>
<ul>
<li><strong>Trabalhadoras informais inscritas como contribuintes individuais:</strong> que contribuem mensalmente para o INSS por conta própria e cumpriram a carência de 10 contribuições</li>
<li><strong>Trabalhadoras rurais (seguradas especiais):</strong> que exercem atividade rural em regime de economia familiar — sem necessidade de contribuição mensal, apenas comprovação da atividade</li>
...
<p>O salário-maternidade tem duração de 120 dias (4 meses) nos casos de parto e adoção de crianças acima de determinadas idades — o prazo pode variar para adoção de crianças menores ou maiores. Para trabalhadoras rurais (seguradas especiais), o valor é sempre um salário mínimo. Para as demais, o valor corresponde à média das últimas 12 contribuições, respeitado o teto do INSS.</p>
...
$content$
WHERE slug = 'salario-maternidade-desempregada-tambem-tem-direito';
